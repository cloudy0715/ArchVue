<template>
  <div id="box">
    ...
    <b-form-select v-model="filterResult" :options="filterVal"></b-form-select>
  </div>
  <div class="mt-3">Selected: <strong>{{ filterType }}{{ filterResult }}</strong></div>
  ...
  watch: {
    filterType: function() {
      ...
      switch(this.filterType) {
        case "region": this.filterVal = this.ResourceRegionResult; break;
        case "tag.Application": this.filterVal = this.tag.Application; break;
        case "tag.Department": this.filterVal = this.tag.Department; break;
        case "tag.Environment": this.filterVal = this.tag.Environment; break;
        case "tag.Owner": this.filterVal = this.tag.Owner; break;
        case "tag.Project": this.filterVal = this.tag.Project; break;
      }
    }
  },
  methods: {
