...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      axios.post('http://44.237.111.172/newPost', this.form, {
        // headers: {
  ...
  mounted() {
    const ddbURL = "https://esrcf3ow2g7pkghwqstdk3z4hy0egoay.lambda-url.us-west-2.on.aws/"
    const user = { user_id: this.form.user_id }
    // try {
    //       // this.loading = true
    //   axios.get(ddbURL, {params: user})
    //     .then((res) => {
